...
@Autonomous(name="Cone Tracker")
public class ConeTrackerTest extends LinearOpMode {
    // Handle hardware stuff...

    int width = 320;
    int height = 240;
    // store as variable here so we can access the location
    ConeTracker cone_tracker = new ConeTracker();
    ...
    public void runOpMode() {
        ...
        phoneCam.setPipeline(cone_tracker);
